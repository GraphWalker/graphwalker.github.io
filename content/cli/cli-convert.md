...
```json
{
   ...
   "vertices":[
      ...
      },
      {
         ...
         "properties":{
            "x":1083.8359375,
            "description":"The user shall be prompted for user credentials",
            "y":376.184751203258
         }
      },
      {
   ...
   "edges":[
      ...
      },
      {
         ...
         "properties":{
            "description":"Log in as Premium user, using valid credentials"
         },
         "sourceVertexId":"n1",
         "targetVertexId":"n2"
      },
      {
         ...
         "name":"e_Logout",
         "properties":{
            "description":"Logout current user from client"
         },
         "sourceVertexId":"n2",
         "targetVertexId":"n1"
      },
...
In version 4, new functionality changed this, from writing to file, to printing to stdout.
